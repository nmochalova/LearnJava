...
public class FinApplication {
    ...
    /* Добавьте здесь метод saveExpense, который будет сохранять значение расходов пользователя.csaveExpense также должен возвращать новое значение остатка средств. */
    ...
    public static void  printAllExpenses (double[] expenses) { // Объявите и реализуйте здесь метод printAllExpenses
