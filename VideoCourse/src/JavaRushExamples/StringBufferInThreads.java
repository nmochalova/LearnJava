...
/*
StringBuffer - это тоже что StringBuilder только умеет работать в нитях (Thread)
 */

public class StringBufferInThreads {
    public static int threadCount = 10;
    public static int[] testArray = new int[1000];

    static {
        for (int i = 0; i < StringBufferInThreads.testArray.length; i++) {
            testArray[i] = i;
        }
    }
