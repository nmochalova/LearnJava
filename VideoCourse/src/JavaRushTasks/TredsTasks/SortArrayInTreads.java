...
/*
Сортируем массив из 1000 элементов в 10 потоках (без синхронизации и volatile)
 */
public class SortArrayInTreads {
    public static int threadCount = 10;
    public  static int[] testArray = new int[1000];

    static {
        for (int i = 0; i < SortArrayInTreads.testArray.length; i++) {
            testArray[i] = i;
        }
    }
